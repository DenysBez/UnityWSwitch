...
namespace Lesson
{
    public sealed class BulletProjectorHelper
    {
        ...
        {
            var light = new GameObject("LightHole").AddComponent<Light>();
